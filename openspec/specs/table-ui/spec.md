...
Единая таблица в визуале Gravity UI на headless TanStack Table: рендер данных
кликабельными строками и сортируемыми заголовками без зависимости от
пакета `@gravity-ui/table`.
