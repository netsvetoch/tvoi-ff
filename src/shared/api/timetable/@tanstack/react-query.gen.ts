 ...
 * Get Unreviewed Photos
 */
export const getUnreviewedPhotosLecturerPhotoReviewGetInfiniteOptions = (options?: Options<GetUnreviewedPhotosLecturerPhotoReviewGetData>) => infiniteQueryOptions<GetUnreviewedPhotosLecturerPhotoReviewGetResponse, GetUnreviewedPhotosLecturerPhotoReviewGetError, InfiniteData<GetUnreviewedPhotosLecturerPhotoReviewGetResponse>, QueryKey<Options<GetUnreviewedPhotosLecturerPhotoReviewGetData>>, number | Pick<QueryKey<Options<GetUnreviewedPhotosLecturerPhotoReviewGetData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
// @ts-ignore
{
    queryFn: async ({ pageParam, queryKey, signal }) => {
        // @ts-ignore
 ...
 * Get Groups
 */
export const getGroupsGroupGetInfiniteOptions = (options?: Options<GetGroupsGroupGetData>) => infiniteQueryOptions<GetGroupsGroupGetResponse, GetGroupsGroupGetError, InfiniteData<GetGroupsGroupGetResponse>, QueryKey<Options<GetGroupsGroupGetData>>, number | Pick<QueryKey<Options<GetGroupsGroupGetData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
// @ts-ignore
{
    queryFn: async ({ pageParam, queryKey, signal }) => {
        // @ts-ignore
 ...
 * Get Rooms
 */
export const getRoomsRoomGetInfiniteOptions = (options?: Options<GetRoomsRoomGetData>) => infiniteQueryOptions<GetRoomsRoomGetResponse, GetRoomsRoomGetError, InfiniteData<GetRoomsRoomGetResponse>, QueryKey<Options<GetRoomsRoomGetData>>, number | Pick<QueryKey<Options<GetRoomsRoomGetData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
// @ts-ignore
{
    queryFn: async ({ pageParam, queryKey, signal }) => {
        // @ts-ignore
 ...
 * Get Events
 */
export const getEventsEventGetInfiniteOptions = (options?: Options<GetEventsEventGetData>) => infiniteQueryOptions<GetEventsEventGetResponse, GetEventsEventGetError, InfiniteData<GetEventsEventGetResponse>, QueryKey<Options<GetEventsEventGetData>>, string | null | Pick<QueryKey<Options<GetEventsEventGetData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
// @ts-ignore
{
    queryFn: async ({ pageParam, queryKey, signal }) => {
        // @ts-ignore
 ...
 * Get Event Comments
 */
export const getEventCommentsEventEventIdCommentGetInfiniteOptions = (options: Options<GetEventCommentsEventEventIdCommentGetData>) => infiniteQueryOptions<GetEventCommentsEventEventIdCommentGetResponse, GetEventCommentsEventEventIdCommentGetError, InfiniteData<GetEventCommentsEventEventIdCommentGetResponse>, QueryKey<Options<GetEventCommentsEventEventIdCommentGetData>>, number | Pick<QueryKey<Options<GetEventCommentsEventEventIdCommentGetData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
// @ts-ignore
{
    queryFn: async ({ pageParam, queryKey, signal }) => {
        // @ts-ignore
