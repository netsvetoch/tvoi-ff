...
import { createCategoryCategoryPost, createParamCategoryCategoryIdParamPost, createSourceSourcePost, deleteCategoryCategoryIdDelete, deleteParamCategoryCategoryIdParamIdDelete, deleteSourceSourceIdDelete, getCategoriesCategoryGet, getCategoryCategoryIdGet, getParamCategoryCategoryIdParamIdGet, getParamsCategoryCategoryIdParamGet, getSourceSourceIdGet, getSourcesSourceGet, getUserCardAdminUserUserIdGet, getUserInfoUserIdGet, getUsersInfoUserGet, type Options, patchCategoryCategoryIdPatch, patchParamCategoryCategoryIdParamIdPatch, patchSourceSourceIdPatch, updateUserCardAdminUserUserIdPatch, updateUserUserIdPost } from '../sdk.gen';
import type { CreateCategoryCategoryPostData, CreateCategoryCategoryPostError, CreateCategoryCategoryPostResponse, CreateParamCategoryCategoryIdParamPostData, CreateParamCategoryCategoryIdParamPostError, CreateParamCategoryCategoryIdParamPostResponse, CreateSourceSourcePostData, CreateSourceSourcePostError, CreateSourceSourcePostResponse, DeleteCategoryCategoryIdDeleteData, DeleteCategoryCategoryIdDeleteError, DeleteCategoryCategoryIdDeleteResponse, DeleteParamCategoryCategoryIdParamIdDeleteData, DeleteParamCategoryCategoryIdParamIdDeleteError, DeleteParamCategoryCategoryIdParamIdDeleteResponse, DeleteSourceSourceIdDeleteData, DeleteSourceSourceIdDeleteError, DeleteSourceSourceIdDeleteResponse, GetCategoriesCategoryGetData, GetCategoriesCategoryGetError, GetCategoriesCategoryGetResponse, GetCategoryCategoryIdGetData, GetCategoryCategoryIdGetError, GetCategoryCategoryIdGetResponse, GetParamCategoryCategoryIdParamIdGetData, GetParamCategoryCategoryIdParamIdGetError, GetParamCategoryCategoryIdParamIdGetResponse, GetParamsCategoryCategoryIdParamGetData, GetParamsCategoryCategoryIdParamGetError, GetParamsCategoryCategoryIdParamGetResponse, GetSourceSourceIdGetData, GetSourceSourceIdGetError, GetSourceSourceIdGetResponse, GetSourcesSourceGetData, GetSourcesSourceGetResponse, GetUserCardAdminUserUserIdGetData, GetUserCardAdminUserUserIdGetError, GetUserCardAdminUserUserIdGetResponse, GetUserInfoUserIdGetData, GetUserInfoUserIdGetError, GetUserInfoUserIdGetResponse, GetUsersInfoUserGetData, GetUsersInfoUserGetError, GetUsersInfoUserGetResponse, PatchCategoryCategoryIdPatchData, PatchCategoryCategoryIdPatchError, PatchCategoryCategoryIdPatchResponse, PatchParamCategoryCategoryIdParamIdPatchData, PatchParamCategoryCategoryIdParamIdPatchError, PatchParamCategoryCategoryIdParamIdPatchResponse, PatchSourceSourceIdPatchData, PatchSourceSourceIdPatchError, PatchSourceSourceIdPatchResponse, UpdateUserCardAdminUserUserIdPatchData, UpdateUserCardAdminUserUserIdPatchError, UpdateUserCardAdminUserUserIdPatchResponse, UpdateUserUserIdPostData, UpdateUserUserIdPostError, UpdateUserUserIdPostResponse } from '../types.gen';
 ...
 */
export const getSourcesSourceGetOptions = (options?: Options<GetSourcesSourceGetData>) => queryOptions<GetSourcesSourceGetResponse, DefaultError, GetSourcesSourceGetResponse, ReturnType<typeof getSourcesSourceGetQueryKey>>({
 ...
 */
export const getSourceSourceIdGetOptions = (options: Options<GetSourceSourceIdGetData>) => queryOptions<GetSourceSourceIdGetResponse, GetSourceSourceIdGetError, GetSourceSourceIdGetResponse, ReturnType<typeof getSourceSourceIdGetQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
 ...
 * Получить категорию
 */
export const getCategoryCategoryIdGetOptions = (options: Options<GetCategoryCategoryIdGetData>) => queryOptions<GetCategoryCategoryIdGetResponse, GetCategoryCategoryIdGetError, GetCategoryCategoryIdGetResponse, ReturnType<typeof getCategoryCategoryIdGetQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
 ...
 */
export const getParamsCategoryCategoryIdParamGetOptions = (options: Options<GetParamsCategoryCategoryIdParamGetData>) => queryOptions<GetParamsCategoryCategoryIdParamGetResponse, GetParamsCategoryCategoryIdParamGetError, GetParamsCategoryCategoryIdParamGetResponse, ReturnType<typeof getParamsCategoryCategoryIdParamGetQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
 ...
 */
export const getParamCategoryCategoryIdParamIdGetOptions = (options: Options<GetParamCategoryCategoryIdParamIdGetData>) => queryOptions<GetParamCategoryCategoryIdParamIdGetResponse, GetParamCategoryCategoryIdParamIdGetError, GetParamCategoryCategoryIdParamIdGetResponse, ReturnType<typeof getParamCategoryCategoryIdParamIdGetQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
 ...
 */
export const getUserInfoUserIdGetOptions = (options: Options<GetUserInfoUserIdGetData>) => queryOptions<GetUserInfoUserIdGetResponse, GetUserInfoUserIdGetError, GetUserInfoUserIdGetResponse, ReturnType<typeof getUserInfoUserIdGetQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
 ...
 */
export const getUsersInfoUserGetOptions = (options: Options<GetUsersInfoUserGetData>) => queryOptions<GetUsersInfoUserGetResponse, GetUsersInfoUserGetError, GetUsersInfoUserGetResponse, ReturnType<typeof getUsersInfoUserGetQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
...
export const getUserCardAdminUserUserIdGetQueryKey = (options: Options<GetUserCardAdminUserUserIdGetData>) => createQueryKey('getUserCardAdminUserUserIdGet', options);
 ...
 */
export const getUserCardAdminUserUserIdGetOptions = (options: Options<GetUserCardAdminUserUserIdGetData>) => queryOptions<GetUserCardAdminUserUserIdGetResponse, GetUserCardAdminUserUserIdGetError, GetUserCardAdminUserUserIdGetResponse, ReturnType<typeof getUserCardAdminUserUserIdGetQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getUserCardAdminUserUserIdGet({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getUserCardAdminUserUserIdGetQueryKey(options)
});
 ...
 */
export const updateUserCardAdminUserUserIdPatchMutation = (options?: Partial<Options<UpdateUserCardAdminUserUserIdPatchData>>): UseMutationOptions<UpdateUserCardAdminUserUserIdPatchResponse, UpdateUserCardAdminUserUserIdPatchError, Options<UpdateUserCardAdminUserUserIdPatchData>> => {
    const mutationOptions: UseMutationOptions<UpdateUserCardAdminUserUserIdPatchResponse, UpdateUserCardAdminUserUserIdPatchError, Options<UpdateUserCardAdminUserUserIdPatchData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await updateUserCardAdminUserUserIdPatch({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
