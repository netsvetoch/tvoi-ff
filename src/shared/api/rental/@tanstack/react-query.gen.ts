 ...
 */
export const getItemsItemGetOptions = (options?: Options<GetItemsItemGetData>) => queryOptions<GetItemsItemGetResponse, GetItemsItemGetError, GetItemsItemGetResponse, ReturnType<typeof getItemsItemGetQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
 ...
 */
export const getItemItemIdGetOptions = (options: Options<GetItemItemIdGetData>) => queryOptions<GetItemItemIdGetResponse, GetItemItemIdGetError, GetItemItemIdGetResponse, ReturnType<typeof getItemItemIdGetQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
 ...
 */
export const deleteRentalSessionRentalSessionsSessionIdDeleteMutation = (options?: Partial<Options<DeleteRentalSessionRentalSessionsSessionIdDeleteData>>): UseMutationOptions<DeleteRentalSessionRentalSessionsSessionIdDeleteResponse, DeleteRentalSessionRentalSessionsSessionIdDeleteError, Options<DeleteRentalSessionRentalSessionsSessionIdDeleteData>> => {
    const mutationOptions: UseMutationOptions<DeleteRentalSessionRentalSessionsSessionIdDeleteResponse, DeleteRentalSessionRentalSessionsSessionIdDeleteError, Options<DeleteRentalSessionRentalSessionsSessionIdDeleteData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await deleteRentalSessionRentalSessionsSessionIdDelete({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 * Get Rental Session
 */
export const getRentalSessionRentalSessionsSessionIdGetOptions = (options: Options<GetRentalSessionRentalSessionsSessionIdGetData>) => queryOptions<GetRentalSessionRentalSessionsSessionIdGetResponse, GetRentalSessionRentalSessionsSessionIdGetError, GetRentalSessionRentalSessionsSessionIdGetResponse, ReturnType<typeof getRentalSessionRentalSessionsSessionIdGetQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
 ...
 */
export const getRentalSessionsRentalSessionsGetOptions = (options?: Options<GetRentalSessionsRentalSessionsGetData>) => queryOptions<GetRentalSessionsRentalSessionsGetResponse, GetRentalSessionsRentalSessionsGetError, GetRentalSessionsRentalSessionsGetResponse, ReturnType<typeof getRentalSessionsRentalSessionsGetQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
 ...
 * Returns a list of rental sessions.
 */
export const getMySessionsRentalSessionsUserMeGetOptions = (options?: Options<GetMySessionsRentalSessionsUserMeGetData>) => queryOptions<GetMySessionsRentalSessionsUserMeGetResponse, GetMySessionsRentalSessionsUserMeGetError, GetMySessionsRentalSessionsUserMeGetResponse, ReturnType<typeof getMySessionsRentalSessionsUserMeGetQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
 ...
 * Raises **ObjectNotFound** if the item type with the specified ID is not found.
 */
export const getItemTypeItemtypeIdGetOptions = (options: Options<GetItemTypeItemtypeIdGetData>) => queryOptions<GetItemTypeItemtypeIdGetResponse, GetItemTypeItemtypeIdGetError, GetItemTypeItemtypeIdGetResponse, ReturnType<typeof getItemTypeItemtypeIdGetQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
 ...
 */
export const getItemsTypesItemtypeGetOptions = (options?: Options<GetItemsTypesItemtypeGetData>) => queryOptions<GetItemsTypesItemtypeGetResponse, DefaultError, GetItemsTypesItemtypeGetResponse, ReturnType<typeof getItemsTypesItemtypeGetQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
 ...
 */
export const getStrikesStrikeGetOptions = (options?: Options<GetStrikesStrikeGetData>) => queryOptions<GetStrikesStrikeGetResponse, GetStrikesStrikeGetError, GetStrikesStrikeGetResponse, ReturnType<typeof getStrikesStrikeGetQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
 ...
 * Returns a list of strikes.
 */
export const getUserStrikesStrikeUserUserIdGetOptions = (options: Options<GetUserStrikesStrikeUserUserIdGetData>) => queryOptions<GetUserStrikesStrikeUserUserIdGetResponse, GetUserStrikesStrikeUserUserIdGetError, GetUserStrikesStrikeUserUserIdGetResponse, ReturnType<typeof getUserStrikesStrikeUserUserIdGetQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
