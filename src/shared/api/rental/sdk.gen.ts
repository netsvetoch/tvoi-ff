 ...
 */
export const getEventsEventGet = <ThrowOnError extends boolean = false>(options?: Options<GetEventsEventGetData, ThrowOnError>): RequestResult<GetEventsEventGetResponses, GetEventsEventGetErrors, ThrowOnError> => (options?.client ?? client).get<GetEventsEventGetResponses, GetEventsEventGetErrors, ThrowOnError>({
 ...
 */
export const getItemsItemGet = <ThrowOnError extends boolean = false>(options?: Options<GetItemsItemGetData, ThrowOnError>): RequestResult<GetItemsItemGetResponses, GetItemsItemGetErrors, ThrowOnError> => (options?.client ?? client).get<GetItemsItemGetResponses, GetItemsItemGetErrors, ThrowOnError>({
    security: [{ name: 'Authorization', type: 'apiKey' }],
    url: '/item',
    ...options
});
 ...
 */
export const deleteItemItemIdDelete = <ThrowOnError extends boolean = false>(options: Options<DeleteItemItemIdDeleteData, ThrowOnError>): RequestResult<DeleteItemItemIdDeleteResponses, DeleteItemItemIdDeleteErrors, ThrowOnError> => (options.client ?? client).delete<DeleteItemItemIdDeleteResponses, DeleteItemItemIdDeleteErrors, ThrowOnError>({
    security: [{ name: 'Authorization', type: 'apiKey' }],
    url: '/item/{id}',
    ...options
});
 ...
 */
export const getItemItemIdGet = <ThrowOnError extends boolean = false>(options: Options<GetItemItemIdGetData, ThrowOnError>): RequestResult<GetItemItemIdGetResponses, GetItemItemIdGetErrors, ThrowOnError> => (options.client ?? client).get<GetItemItemIdGetResponses, GetItemItemIdGetErrors, ThrowOnError>({ url: '/item/{id}', ...options });
 ...
 * Raises **ObjectNotFound** if the item with the specified ID is not found.
 */
export const updateItemItemIdPatch = <ThrowOnError extends boolean = false>(options: Options<UpdateItemItemIdPatchData, ThrowOnError>): RequestResult<UpdateItemItemIdPatchResponses, UpdateItemItemIdPatchErrors, ThrowOnError> => (options.client ?? client).patch<UpdateItemItemIdPatchResponses, UpdateItemItemIdPatchErrors, ThrowOnError>({
    security: [{ name: 'Authorization', type: 'apiKey' }],
    url: '/item/{id}',
    ...options
});
 ...
 */
export const startRentalSessionRentalSessionsSessionIdStartPatch = <ThrowOnError extends boolean = false>(options: Options<StartRentalSessionRentalSessionsSessionIdStartPatchData, ThrowOnError>): RequestResult<StartRentalSessionRentalSessionsSessionIdStartPatchResponses, StartRentalSessionRentalSessionsSessionIdStartPatchErrors, ThrowOnError> => (options.client ?? client).patch<StartRentalSessionRentalSessionsSessionIdStartPatchResponses, StartRentalSessionRentalSessionsSessionIdStartPatchErrors, ThrowOnError>({
    security: [{ name: 'Authorization', type: 'apiKey' }],
 ...
 */
export const acceptEndRentalSessionRentalSessionsSessionIdReturnPatch = <ThrowOnError extends boolean = false>(options: Options<AcceptEndRentalSessionRentalSessionsSessionIdReturnPatchData, ThrowOnError>): RequestResult<AcceptEndRentalSessionRentalSessionsSessionIdReturnPatchResponses, AcceptEndRentalSessionRentalSessionsSessionIdReturnPatchErrors, ThrowOnError> => (options.client ?? client).patch<AcceptEndRentalSessionRentalSessionsSessionIdReturnPatchResponses, AcceptEndRentalSessionRentalSessionsSessionIdReturnPatchErrors, ThrowOnError>({
    security: [{ name: 'Authorization', type: 'apiKey' }],
 ...
 */
export const deleteRentalSessionRentalSessionsSessionIdDelete = <ThrowOnError extends boolean = false>(options: Options<DeleteRentalSessionRentalSessionsSessionIdDeleteData, ThrowOnError>): RequestResult<DeleteRentalSessionRentalSessionsSessionIdDeleteResponses, DeleteRentalSessionRentalSessionsSessionIdDeleteErrors, ThrowOnError> => (options.client ?? client).delete<DeleteRentalSessionRentalSessionsSessionIdDeleteResponses, DeleteRentalSessionRentalSessionsSessionIdDeleteErrors, ThrowOnError>({
    security: [{ name: 'Authorization', type: 'apiKey' }],
 ...
 * Get Rental Session
 */
export const getRentalSessionRentalSessionsSessionIdGet = <ThrowOnError extends boolean = false>(options: Options<GetRentalSessionRentalSessionsSessionIdGetData, ThrowOnError>): RequestResult<GetRentalSessionRentalSessionsSessionIdGetResponses, GetRentalSessionRentalSessionsSessionIdGetErrors, ThrowOnError> => (options.client ?? client).get<GetRentalSessionRentalSessionsSessionIdGetResponses, GetRentalSessionRentalSessionsSessionIdGetErrors, ThrowOnError>({
    security: [{ name: 'Authorization', type: 'apiKey' }],
    url: '/rental-sessions/{session_id}',
    ...options
});
 ...
 * Raises **ObjectNotFound** if the session with the specified ID is not found.
 */
export const updateRentalSessionRentalSessionsSessionIdPatch = <ThrowOnError extends boolean = false>(options: Options<UpdateRentalSessionRentalSessionsSessionIdPatchData, ThrowOnError>): RequestResult<UpdateRentalSessionRentalSessionsSessionIdPatchResponses, UpdateRentalSessionRentalSessionsSessionIdPatchErrors, ThrowOnError> => (options.client ?? client).patch<UpdateRentalSessionRentalSessionsSessionIdPatchResponses, UpdateRentalSessionRentalSessionsSessionIdPatchErrors, ThrowOnError>({
    security: [{ name: 'Authorization', type: 'apiKey' }],
    url: '/rental-sessions/{session_id}',
    ...options,
    headers: {
 ...
 */
export const getRentalSessionsRentalSessionsGet = <ThrowOnError extends boolean = false>(options?: Options<GetRentalSessionsRentalSessionsGetData, ThrowOnError>): RequestResult<GetRentalSessionsRentalSessionsGetResponses, GetRentalSessionsRentalSessionsGetErrors, ThrowOnError> => (options?.client ?? client).get<GetRentalSessionsRentalSessionsGetResponses, GetRentalSessionsRentalSessionsGetErrors, ThrowOnError>({
    security: [{ name: 'Authorization', type: 'apiKey' }],
    url: '/rental-sessions',
    ...options
});
 ...
 * Returns a list of rental sessions.
 */
export const getMySessionsRentalSessionsUserMeGet = <ThrowOnError extends boolean = false>(options?: Options<GetMySessionsRentalSessionsUserMeGetData, ThrowOnError>): RequestResult<GetMySessionsRentalSessionsUserMeGetResponses, GetMySessionsRentalSessionsUserMeGetErrors, ThrowOnError> => (options?.client ?? client).get<GetMySessionsRentalSessionsUserMeGetResponses, GetMySessionsRentalSessionsUserMeGetErrors, ThrowOnError>({
    security: [{ name: 'Authorization', type: 'apiKey' }],
 ...
 */
export const cancelRentalSessionRentalSessionsSessionIdCancelDelete = <ThrowOnError extends boolean = false>(options: Options<CancelRentalSessionRentalSessionsSessionIdCancelDeleteData, ThrowOnError>): RequestResult<CancelRentalSessionRentalSessionsSessionIdCancelDeleteResponses, CancelRentalSessionRentalSessionsSessionIdCancelDeleteErrors, ThrowOnError> => (options.client ?? client).delete<CancelRentalSessionRentalSessionsSessionIdCancelDeleteResponses, CancelRentalSessionRentalSessionsSessionIdCancelDeleteErrors, ThrowOnError>({
    security: [{ name: 'Authorization', type: 'apiKey' }],
 ...
 */
export const deleteItemTypeItemtypeIdDelete = <ThrowOnError extends boolean = false>(options: Options<DeleteItemTypeItemtypeIdDeleteData, ThrowOnError>): RequestResult<DeleteItemTypeItemtypeIdDeleteResponses, DeleteItemTypeItemtypeIdDeleteErrors, ThrowOnError> => (options.client ?? client).delete<DeleteItemTypeItemtypeIdDeleteResponses, DeleteItemTypeItemtypeIdDeleteErrors, ThrowOnError>({
    security: [{ name: 'Authorization', type: 'apiKey' }],
    url: '/itemtype/{id}',
    ...options
});
 ...
 * Raises **ObjectNotFound** if the item type with the specified ID is not found.
 */
export const getItemTypeItemtypeIdGet = <ThrowOnError extends boolean = false>(options: Options<GetItemTypeItemtypeIdGetData, ThrowOnError>): RequestResult<GetItemTypeItemtypeIdGetResponses, GetItemTypeItemtypeIdGetErrors, ThrowOnError> => (options.client ?? client).get<GetItemTypeItemtypeIdGetResponses, GetItemTypeItemtypeIdGetErrors, ThrowOnError>({
    security: [{ name: 'Authorization', type: 'apiKey' }],
    url: '/itemtype/{id}',
    ...options
});
 ...
 * Raises **ObjectNotFound** if the item type with the specified ID is not found.
 */
export const updateItemTypeItemtypeIdPatch = <ThrowOnError extends boolean = false>(options: Options<UpdateItemTypeItemtypeIdPatchData, ThrowOnError>): RequestResult<UpdateItemTypeItemtypeIdPatchResponses, UpdateItemTypeItemtypeIdPatchErrors, ThrowOnError> => (options.client ?? client).patch<UpdateItemTypeItemtypeIdPatchResponses, UpdateItemTypeItemtypeIdPatchErrors, ThrowOnError>({
    security: [{ name: 'Authorization', type: 'apiKey' }],
    url: '/itemtype/{id}',
    ...options,
    headers: {
 ...
 */
export const getItemsTypesItemtypeGet = <ThrowOnError extends boolean = false>(options?: Options<GetItemsTypesItemtypeGetData, ThrowOnError>): RequestResult<GetItemsTypesItemtypeGetResponses, unknown, ThrowOnError> => (options?.client ?? client).get<GetItemsTypesItemtypeGetResponses, unknown, ThrowOnError>({
    security: [{ name: 'Authorization', type: 'apiKey' }],
    url: '/itemtype',
    ...options
});
 ...
 */
export const createItemTypeItemtypePost = <ThrowOnError extends boolean = false>(options: Options<CreateItemTypeItemtypePostData, ThrowOnError>): RequestResult<CreateItemTypeItemtypePostResponses, CreateItemTypeItemtypePostErrors, ThrowOnError> => (options.client ?? client).post<CreateItemTypeItemtypePostResponses, CreateItemTypeItemtypePostErrors, ThrowOnError>({
    security: [{ name: 'Authorization', type: 'apiKey' }],
    url: '/itemtype',
    ...options,
    headers: {
 ...
 */
export const makeItemTypeAvailableItemtypeAvailableIdPatch = <ThrowOnError extends boolean = false>(options: Options<MakeItemTypeAvailableItemtypeAvailableIdPatchData, ThrowOnError>): RequestResult<MakeItemTypeAvailableItemtypeAvailableIdPatchResponses, MakeItemTypeAvailableItemtypeAvailableIdPatchErrors, ThrowOnError> => (options.client ?? client).patch<MakeItemTypeAvailableItemtypeAvailableIdPatchResponses, MakeItemTypeAvailableItemtypeAvailableIdPatchErrors, ThrowOnError>({
    security: [{ name: 'Authorization', type: 'apiKey' }],
 ...
 */
export const getStrikesStrikeGet = <ThrowOnError extends boolean = false>(options?: Options<GetStrikesStrikeGetData, ThrowOnError>): RequestResult<GetStrikesStrikeGetResponses, GetStrikesStrikeGetErrors, ThrowOnError> => (options?.client ?? client).get<GetStrikesStrikeGetResponses, GetStrikesStrikeGetErrors, ThrowOnError>({
    security: [{ name: 'Authorization', type: 'apiKey' }],
    url: '/strike',
    ...options
});
 ...
 */
export const createStrikeStrikePost = <ThrowOnError extends boolean = false>(options: Options<CreateStrikeStrikePostData, ThrowOnError>): RequestResult<CreateStrikeStrikePostResponses, CreateStrikeStrikePostErrors, ThrowOnError> => (options.client ?? client).post<CreateStrikeStrikePostResponses, CreateStrikeStrikePostErrors, ThrowOnError>({
    security: [{ name: 'Authorization', type: 'apiKey' }],
    url: '/strike',
    ...options,
    headers: {
 ...
 * Returns a list of strikes.
 */
export const getUserStrikesStrikeUserUserIdGet = <ThrowOnError extends boolean = false>(options: Options<GetUserStrikesStrikeUserUserIdGetData, ThrowOnError>): RequestResult<GetUserStrikesStrikeUserUserIdGetResponses, GetUserStrikesStrikeUserUserIdGetErrors, ThrowOnError> => (options.client ?? client).get<GetUserStrikesStrikeUserUserIdGetResponses, GetUserStrikesStrikeUserUserIdGetErrors, ThrowOnError>({ url: '/strike/user/{user_id}', ...options });
 ...
 */
export const deleteStrikeStrikeIdDelete = <ThrowOnError extends boolean = false>(options: Options<DeleteStrikeStrikeIdDeleteData, ThrowOnError>): RequestResult<DeleteStrikeStrikeIdDeleteResponses, DeleteStrikeStrikeIdDeleteErrors, ThrowOnError> => (options.client ?? client).delete<DeleteStrikeStrikeIdDeleteResponses, DeleteStrikeStrikeIdDeleteErrors, ThrowOnError>({
    security: [{ name: 'Authorization', type: 'apiKey' }],
    url: '/strike/{id}',
    ...options
});
