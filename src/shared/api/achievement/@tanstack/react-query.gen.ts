 ...
 */
export const getAllAchievementsAchievementGetOptions = (options?: Options<GetAllAchievementsAchievementGetData>) => queryOptions<GetAllAchievementsAchievementGetResponse, DefaultError, GetAllAchievementsAchievementGetResponse, ReturnType<typeof getAllAchievementsAchievementGetQueryKey>>({
 ...
 * Get Achievement
 */
export const getAchievementAchievementIdGetOptions = (options: Options<GetAchievementAchievementIdGetData>) => queryOptions<GetAchievementAchievementIdGetResponse, GetAchievementAchievementIdGetError, GetAchievementAchievementIdGetResponse, ReturnType<typeof getAchievementAchievementIdGetQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
 ...
 * Get All Recievers
 */
export const getAllRecieversAchievementAchievementIdRecieverGetOptions = (options: Options<GetAllRecieversAchievementAchievementIdRecieverGetData>) => queryOptions<GetAllRecieversAchievementAchievementIdRecieverGetResponse, GetAllRecieversAchievementAchievementIdRecieverGetError, GetAllRecieversAchievementAchievementIdRecieverGetResponse, ReturnType<typeof getAllRecieversAchievementAchievementIdRecieverGetQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
 ...
 * Get All Achievements
 */
export const getAllAchievementsUserUserIdGetOptions = (options: Options<GetAllAchievementsUserUserIdGetData>) => queryOptions<GetAllAchievementsUserUserIdGetResponse, GetAllAchievementsUserUserIdGetError, GetAllAchievementsUserUserIdGetResponse, ReturnType<typeof getAllAchievementsUserUserIdGetQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
